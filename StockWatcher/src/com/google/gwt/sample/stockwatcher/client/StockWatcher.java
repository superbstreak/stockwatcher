...
public class StockWatcher implements EntryPoint {
	...
	//TODO Service API for user login informations	
...
/**  * Entry point method.  */
	 private void loadStockWatcher() {  
	    ...
	    //TODO Listen for keyboard events in the input box.
	  ...
	  private void displayStock(final String symbol){
		// TODO Add the stock to the table. if isnt already in the table 
